from framed.solvers.solution import print_values, print_balance
...
class CommunitySolution(object):
    ...
    def parse_solution(self):
        ...
        self.abundance = {org_id: solution.values["x_{}".format(org_id)]
        ...
        for m_id in mets:
            ...
            if entries:
                ...
                for (sense, org_id, rate) in entries:
                    print('[ {} ] {:<12} {:< 10.6g}'.format(sense, org_id, rate))